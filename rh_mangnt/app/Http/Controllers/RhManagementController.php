...
class RhManagementController extends Controller
{
    ...
    public function createColaborator(Request $request)
    {
        ...
        // verificar se o departamento é o RH -> id == 2
        if ($request->select_department <= 2) {
            return redirect()->route('home');
        }

        // criar token de confirmacao do usuario
        $token = Str::random(60);

        // criar novo usuario do rh
        $user = new User();
    ...
    public function updateColaborator(Request $request)
    {
        ...
        // checar se o departamento é válido
        if($request->select_department <= 2){
            return redirect()->route('home');
        }
        ...
        public function deleteColaboratorConfirm($id)
    {
        ...
        return redirect()->route('rh.management.home')->with('success', 'Colaborador deletado com sucesso.');
    }
