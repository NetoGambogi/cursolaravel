    ...
    <div class="container my-5">
        ...
        <hr>
            <div class="text-center">
                Usuário: <strong class="text-info">{{ auth()->user()->name ?? "Não informado"}}</strong>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-4 p-3">
                <div class="border border-2 rounded-3 border-secondary p-5 text-center">
                    ...
                    <a href="{{ route('plan.selected', ['id' => urlencode($prices['monthly'])]) }}" class="btn btn-secondary mt-3 w-100">ASSINAR</a>
                </div>
            </div>
            ...
            <div class="col-4 p-3">
                <div class="border border-5 rounded-3 border-success p-5 text-center bg-black">
                    ...
                    <a href="{{ route('plan.selected', ['id' => urlencode($prices['yearly'])]) }}" class="btn btn-success mt-3 w-100">ASSINAR</a>
            ...
            <div class="col-4 p-3">
                <div class="border border-2 rounded-3 border-warning p-5 text-center">
                    ...
                    <hr>
                    <h1 class="text-center text-white">149.99$</h4>
                    <a href="{{ route('plan.selected', ['id' => urlencode($prices['longest'])]) }}" class="btn btn-warning mt-3 w-100">ASSINAR</a>
                </div>
            </div>
