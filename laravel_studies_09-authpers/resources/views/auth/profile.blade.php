...
<x-layouts.main-layout pageTitle="Perfil do usuário">
        ...
        <div class="row justify-content-center">
            <div class="col-6">
                    ...
                    <div class="card border-1 border-danger p-5 text-center">
                        Se deseja apagar sua conta de usuário de forma permanente, escreva o texto "APAGAR" e clique no botão abaixo.
                    ...
                    <form action="{{route('delete_account')}}" method="post">
                        ...
                        <div class="my-3 ">
                            <input type="text" name="delete_confirmation" class="form-control text-center">
